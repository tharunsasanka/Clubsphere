...
class ZipFileSystem extends FileSystem {
    ...
    /**
     * Property which specifies whether opening of a ZIP file with an entry '.' or '..' element
     * in its name as a file system is allowed.
     */
    @SuppressWarnings("removal")
    private static final String allowDotZipEntry = AccessController.doPrivileged(
        (PrivilegedAction<String>)()->System.getProperty("jdk.nio.zipfs.allowDotZipEntry"));

    private static final boolean useLegacy = ((allowDotZipEntry != null)
             && (allowDotZipEntry.isEmpty() || allowDotZipEntry.equalsIgnoreCase("true")));
    ...
    private byte[] initCEN() throws IOException {
        ...
        while (pos < limit) {
            ...
            if (!useLegacy && hasDotOrDotDot(inode.name)) {
